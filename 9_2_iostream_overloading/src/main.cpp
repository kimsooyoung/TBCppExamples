...
public:
    Point(const double &x_in = 0.0, const double &y_in = 0.0, const double &z_in = 0.0) : m_x(x_in), m_y(y_in), m_z(z_in) {}
...
int main()
{
...

    {
        ...
        while (true)
        {
            cout << "Type Three coordinate elements (x y z) : ";
            cin >> p_1;
